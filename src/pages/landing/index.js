            ...
            <Grid.Row>
              <Grid.Column width={14}>
                ...
                <p className="text-lg">
                  ...
                  spesifikasi seperti processor, RAM, kapasitas penyimpanan,
                  merek, dan harga. Beberapa situs-situs jual beli di Indonesia
                  sudah memiliki fitur <i>filtering</i> untuk poin-poin
                  tersebut, namun rata-rata hanya memiliki <i>filter</i> berupa
                  merek dan harga. Beberapa situs-situs luar negeri sudah
                  memiliki <i>filter</i> yang cukup lengkap. Namun jika kita
                  memakai situs luar negeri, kita tidak tahu apakah
                  produk-produk laptop yang ditampilkan sudah ada di Indonesia
                  atau belum. Untuk alasan itulah, saya mencoba membuat sebuah
                  Mesin Pencari Laptop untuk orang-orang di Indonesia.
                </p>
                <p className="text-lg">
                  Mesin Pencari Laptop adalah sebuah alat yang bisa kamu gunakan
                  untuk mencari laptop sesuai dengan spesifikasimu. Mesin
                  pencari laptop ini menggunakan data dari{' '}
                  ...
                  processor, RAM, kapasitas penyimpanan, merek, dan harga. Saya
